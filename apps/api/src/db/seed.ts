...
await db.insert(plans).values([
  ...
  { id: "free", name: "Free", priceMonth: null, limits: { screens: 1, devices: 1, custom_backgrounds: true, history_days: 365, radio: true, branding: true } },
  { id: "pro", name: "Pro", priceMonth: 60000, limits: { screens: 5, devices: 5, custom_backgrounds: true, history_days: 365, radio: true, branding: false } },
  { id: "max", name: "Max", priceMonth: null, limits: { screens: 50, devices: 50, custom_backgrounds: true, history_days: 730, radio: true, branding: false } },

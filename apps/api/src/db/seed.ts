...
await db.insert(plans).values([
  ...
  { id: "free", name: "Free", priceMonth: null, limits: { screens: 1, devices: 1, custom_backgrounds: true, history_days: 365, radio: true, branding: true, menus: 1, ai_dishes: 20, ai_generations_month: 60, custom_radio: 5 } },
  { id: "pro", name: "Pro", priceMonth: 60000, limits: { screens: 5, devices: 5, custom_backgrounds: true, history_days: 365, radio: true, branding: false, menus: 5, ai_dishes: 200, ai_generations_month: 600, custom_radio: 30 } },
  { id: "max", name: "Max", priceMonth: null, limits: { screens: 50, devices: 50, custom_backgrounds: true, history_days: 730, radio: true, branding: false, menus: 50, ai_dishes: 1000, ai_generations_month: 5000, custom_radio: 100 } },

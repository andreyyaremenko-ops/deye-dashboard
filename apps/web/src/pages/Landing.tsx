  ...
  return <div className="land">
    ...
    <section id="features" className="land-sec">
      ...
      <div className="feats">
        ...
        {[
          ["🎞", "Відеофони", "Камін, водоспад, акваріум, дощ за вікном: понад 30 кліпів з ліцензією для закладів. У Pro — власні відео та фото."],
    ...
    <section id="pricing" className="land-sec">
      ...
      <div className="plans plans-3">
        ...
        <div className="plan pro">
          ...
          <ul><li>До 5 екранів</li><li>Власні відеофони та фото</li><li>Онлайн-радіо</li><li>Історія та графіки за рік</li><li>Без брендингу</li></ul>
